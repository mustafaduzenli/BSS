...
module.exports = function(app, express) {
	...
	apiRouter.post('/sample', function(req, res) {
        ...
        connection.query("SELECT * FROM user WHERE username = ?",['md'], function(err, rows) {
            if (err)
                return res.send(err);
            if (!rows.length) {
                var newUserMysql = {
                    ...
                    first_name: 'mustafa',
                    last_name: 'duzenli',
                    email: 'mduzenli@hayat.com.tr'
                };
                var insertQuery = "INSERT INTO users ( username, password, user_type, user_status, \
